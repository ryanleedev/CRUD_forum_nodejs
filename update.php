<!--
    ...
    Date: Apr 3rd
    File: update.php
    Lab Objective: This is update php for editing and updating posts
-->
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    echo "<script>console.log('$imglist');</script>";
    ...
    if(empty($author_err) && empty($pwd_err) && empty($subject_err) && empty($text_err)){
        ...
        $addResult = $postDAO->updatePost($post);    
    ...
    <div class="container">
        ...
        <div class="form-group">
            <input
                ...
                value="<?php echo $post->getSubject(); ?>"
                placeholder="Subject">
